...
const zhSidebar = [
  {
    ...
    items: [
      ...
      { text: '完整示例', link: '/guide/examples' },
      {
        ...
        link: '/guide/recipes/',
        items: [
          { text: 'Recipes 总览', link: '/guide/recipes/' },
          { text: '后台富文本表单', link: '/guide/recipes/business-editor-form' },
          { text: '自动保存 + 本地草稿', link: '/guide/recipes/autosave-drafts' },
          { text: '图片、视频和附件上传', link: '/guide/recipes/uploads' },
          { text: '只读预览和详情页', link: '/guide/recipes/readonly-preview' },
        ],
      },
      { text: '在线体验', link: '/guide/live-demo' },
      ...
      { text: '自动保存', link: '/guide/autosave' },
      { text: '本地草稿恢复', link: '/guide/local-drafts' },
...
const enSidebar = [
  {
    ...
    items: [
      ...
      {
        text: 'Business Recipes',
        link: '/en/guide/recipes/',
        items: [
          { text: 'Recipes Overview', link: '/en/guide/recipes/' },
          { text: 'Admin Rich Text Form', link: '/en/guide/recipes/business-editor-form' },
          { text: 'Autosave + Local Drafts', link: '/en/guide/recipes/autosave-drafts' },
          { text: 'Uploads', link: '/en/guide/recipes/uploads' },
          { text: 'Readonly Preview', link: '/en/guide/recipes/readonly-preview' },
        ],
      },
      { text: 'Live Demo', link: '/en/guide/live-demo' },
      ...
      { text: 'Math Formulas', link: '/en/guide/math' },
      { text: 'Autosave', link: '/en/guide/autosave' },
      { text: 'Local Draft Recovery', link: '/en/guide/local-drafts' },
...
(function() {
  ...
  s.parentNode.insertBefore(hm, s);
    ...
    [
      'script',
      {},
      `!function(p){"use strict";!function(t){var s=window,e=document,i=p,c="".concat("https:"===e.location.protocol?"https://":"http://","sdk.51.la/js-sdk-pro.min.js"),n=e.createElement("script"),r=e.getElementsByTagName("script")[0];n.type="text/javascript",n.setAttribute("charset","UTF-8"),n.async=!0,n.src=c,n.id="LA_COLLECT",i.d=n;var o=function(){s.LA.ids.push(i)};s.LA?s.LA.ids&&o():(s.LA=p,s.LA.ids=[],o()),r.parentNode.insertBefore(n,r)}()}({id:"3Qv7VJV5z6CiM9pv",ck:"3Qv7VJV5z6CiM9pv",autoTrack:true,hashMode:true,screenRecord:true});`,
    ],
  ],
  srcExclude: ['feature-gap-analysis.md', 'plans/**', 'current/**', 'iteration-plan-*.md', 'math-katex-design-revised.md'],
  cleanUrls: true,
  lastUpdated: true,
  markdown: {
    config(md) {
