...
- 段落/标题缩进,以及列表层级缩进
- 链接、图片、视频、音频、文件附件、表格列宽拖动、表格选择与行列操作、任务列表、代码块、独立 Mermaid 块、Markdown 导入导出
- 代码块支持 17 种默认语言语法高亮,并导出语言标签、语言图标和当前代码块解析能力供 Adapter 使用
- Mermaid 代码/图表/分屏视图、按需加载的 CodeMirror 编辑器和 Mermaid 渲染器
