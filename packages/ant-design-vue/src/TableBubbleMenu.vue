...
<template>
  <div ref="rootEl" class="tvp-table-bubble">
    ...
    <AntTooltip v-if="tableState.canMerge" content="合并单元格" placement="top" :show-after="400">
      <AntButton text class="tvp-icon-btn" @click="ctx.commands.mergeCells()"><Combine :size="15" /></AntButton>
    </AntTooltip>
    <AntTooltip v-if="tableState.canSplit" content="拆分单元格" placement="top" :show-after="400">
    ...
    <AntDropdown v-model:visible="moreMenuShow" trigger="click" @command="run">
