...
<style scoped>
.tvp-math-node {
  --tvp-math-muted: #8c8c8c;
  --tvp-math-error: #ff4d4f;
  --tvp-math-border: #d9d9d9;
  --tvp-math-subtle: #fafafa;
  --tvp-math-primary: var(--tvp-ant-color-primary, #1677ff);
  --tvp-math-primary-soft: var(--tvp-ant-color-primary-light-5, #4096ff);
}
