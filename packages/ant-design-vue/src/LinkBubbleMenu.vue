...
<template>
  <div ref="rootEl" class="tvp-link-bubble">
    <AntTooltip :content="t('toolbar.link.edit')" placement="top" :show-after="300">
      <AntButton text :aria-label="t('toolbar.link.edit')" @click="openEditDialog">
        <Pencil :size="16" />
      </AntButton>
    </AntTooltip>
    <AntTooltip :content="t('toolbar.link.open')" placement="top" :show-after="300">
      <AntButton text :aria-label="t('toolbar.link.open')" @click="openLink">
        <ExternalLink :size="16" />
      </AntButton>
    </AntTooltip>
    <AntTooltip :content="t('toolbar.link.copy')" placement="top" :show-after="300">
      <AntButton text :aria-label="t('toolbar.link.copy')" @click="copyLink">
        <Copy :size="16" />
      </AntButton>
    </AntTooltip>
    <AntDivider direction="vertical" />
    <AntTooltip :content="t('toolbar.link.remove')" placement="top" :show-after="300">
      <AntButton text :aria-label="t('toolbar.link.remove')" @click="removeLink">
        <Unlink :size="16" />
      </AntButton>
    </AntTooltip>
