...
import { AntButton, AntTooltip, AntDropdown, AntDropdownMenu, AntDropdownItem, AntModal, AntInput, AntCheckbox } from './antDesignPrimitives'
import {
...
<template>
  <div class="tvp-toolbar">
    ...
    <template v-for="(group, groupIndex) in toolbarGroups" :key="groupIndex">
      ...
      <template v-for="item in group" :key="item">
        <AntTooltip v-if="item === 'undo'" :content="commandLabel('undo')" placement="top" :show-after="300">
          <AntButton text class="tvp-icon-btn" :aria-label="commandLabel('undo')" @click="runCommand('undo')"><Undo2 :size="18" /></AntButton>
        </AntTooltip>

        <AntTooltip v-else-if="item === 'redo'" :content="commandLabel('redo')" placement="top" :show-after="300">
          <AntButton text class="tvp-icon-btn" :aria-label="commandLabel('redo')" @click="runCommand('redo')"><Redo2 :size="18" /></AntButton>
        </AntTooltip>

        <AntDropdown v-else-if="item === 'heading'" trigger="click" @command="onHeading">
          <AntButton text :aria-label="commandLabel('heading')">
            {{ headingLabel }}
        ...
        <AntTooltip v-else-if="item === 'strike'" :content="commandLabel('strike')" placement="top" :show-after="300">
          ...
          ><Strikethrough :size="18" /></AntButton>
        </AntTooltip>
        ...
        <AntTooltip v-else-if="item === 'decreaseIndent'" :content="commandLabel('decreaseIndent')" placement="top" :show-after="300">
          ...
          ><IndentDecrease :size="18" /></AntButton>
        </AntTooltip>
        ...
        <AntTooltip v-else-if="item === 'increaseIndent'" :content="commandLabel('increaseIndent')" placement="top" :show-after="300">
          ...
          ><IndentIncrease :size="18" /></AntButton>
        </AntTooltip>
        ...
        <AntTooltip v-else-if="item === 'hr'" :content="commandLabel('hr')" placement="top" :show-after="300">
          <AntButton text class="tvp-icon-btn" :aria-label="commandLabel('hr')" @click="runCommand('hr')"><Minus :size="18" /></AntButton>
        </AntTooltip>
        ...
        <AntTooltip v-else-if="item === 'link'" :content="commandLabel('link')" placement="top" :show-after="300">
          ...
          ><Link :size="18" /></AntButton>
        </AntTooltip>

        <template v-else-if="item === 'image'">
          <AntTooltip v-if="uploadImage" content="上传图片" placement="top" :show-after="300">
            <AntButton text class="tvp-icon-btn" aria-label="上传图片" @click="triggerImageUpload"><ImagePlus :size="18" /></AntButton>
          </AntTooltip>
          <AntTooltip content="网络图片" placement="top" :show-after="300">
            <AntButton text class="tvp-icon-btn" aria-label="网络图片" @click="openUrlDialog"><Link2 :size="18" /></AntButton>
          </AntTooltip>
        </template>

        <AntTooltip v-else-if="item === 'table'" :content="commandLabel('table')" placement="top" :show-after="300">
          <AntDropdown ref="tableDropdown" trigger="click" @command="onTableInsert">
            <AntButton text class="tvp-icon-btn" :aria-label="commandLabel('table')"><Table :size="18" /></AntButton>
            <template #dropdown>
        ...
        <AntTooltip v-else-if="item === 'markdown'" :content="commandLabel('markdown')" placement="top" :show-after="300">
          <AntDropdown trigger="click" @command="onMarkdownCommand">
            <AntButton text class="tvp-icon-btn" :aria-label="commandLabel('markdown')"><MarkdownIcon :size="18" /></AntButton>
            <template #dropdown>
              <AntDropdownMenu>
                <AntDropdownItem
        ...
        <AntTooltip v-else-if="item === 'print'" :content="commandLabel('print')" placement="top" :show-after="300">
          <AntButton text class="tvp-icon-btn" :aria-label="commandLabel('print')" @click="printContent"><Printer :size="18" /></AntButton>
        </AntTooltip>

        <AntTooltip v-else-if="item === 'fullscreen'" :content="isFullscreen ? '退出全屏' : '全屏'" placement="top" :show-after="300">
          <AntButton text class="tvp-icon-btn" :aria-label="isFullscreen ? '退出全屏' : '全屏'" @click="toggleFullscreen">
            <component :is="isFullscreen ? Minimize2 : Maximize2" :size="18" />
          </AntButton>
        </AntTooltip>

        <AntTooltip v-else-if="item === 'preview'" :content="isPreview ? '编辑' : '预览'" placement="top" :show-after="300">
          <AntButton text class="tvp-icon-btn" :aria-label="isPreview ? '编辑' : '预览'" @click="togglePreview">
    ...
    <AntModal v-model="urlDialogVisible" title="插入网络图片" width="420px" append-to-body>
      <AntInput
        v-model="imageUrl"
      ...
      />
      <template #footer>
        <AntButton @click="urlDialogVisible = false">取消</AntButton>
        <AntButton type="primary" @click="confirmUrlImage">确定</AntButton>
      </template>
    </AntModal>
    ...
    >
      <div class="tvp-link-form">
        ...
        <div class="tvp-link-form__row tvp-link-form__row--check">
          <AntCheckbox v-model="linkNewTab">在新窗口打开</AntCheckbox>
        </div>
      </div>
      <template #footer>
        <AntButton @click="linkDialogVisible = false">取消</AntButton>
        <AntButton type="primary" @click="confirmLink">确定</AntButton>
      </template>
    </AntModal>
  </div>
</template>
