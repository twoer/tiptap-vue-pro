...
<template>
  <div ref="rootEl" class="tvp-math-bubble" :data-math-kind="selectedMath?.kind">
    <AntTooltip :title="t('math.action.edit')" placement="top">
      <AntButton type="text" :aria-label="t('math.action.edit')" @click="editMath">
    ...
    <AntTooltip :title="t('math.action.delete')" placement="top">
      <AntButton type="text" :aria-label="t('math.action.delete')" @click="deleteMath">
...
.tvp-math-bubble :deep(.tvp-ant-divider--vertical) {
  margin: 0 4px;
}
</style>
