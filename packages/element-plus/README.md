...
- 链接、图片上传/网络图片、视频/音频/文件上传、表格网格、列宽拖动、行列抓手、区域选择、Mermaid、Markdown 导入导出
- 代码块支持 17 种默认语言语法高亮、语言图标、上下文切换语言和一键复制
- Slash Command 快捷插入:输入 `/` 可搜索并插入标题、待办、列表、表格、图片、分割线、代码块和 Mermaid 图表
