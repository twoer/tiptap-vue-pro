  ...
  <div class="tvp-toolbar" :class="`is-${toolbarLayout.mode}`">
    ...
    >
      ...
      <span class="tvp-toolbar-group">
        ...
        <ElTooltip v-else-if="item === 'math'" :content="commandLabel('math')" placement="top" :show-after="300">
          <ElButton text class="tvp-icon-btn" :aria-label="commandLabel('math')" @click="ctx.prepareInsert?.(); runCommand('math')"><Sigma :size="16" /></ElButton>
        </ElTooltip>
    ...
    >
      ...
      <template #footer>
        <ElButton @click="cancelLink">{{ t('toolbar.action.cancel') }}</ElButton>
