...
describe('Element Plus LinkBubbleMenu', () => {
  ...
  it('上下文 tooltip 不 teleport 到 body,避免菜单隐藏后残留在左上角', () => {
    const source = readFileSync(`${process.cwd()}/src/LinkBubbleMenu.vue`, 'utf8')

    expect(source).toContain('<ElTooltip :teleported="false"')
