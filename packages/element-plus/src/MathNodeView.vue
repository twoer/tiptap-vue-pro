...
<style scoped>
.tvp-math-node {
  --tvp-math-muted: var(--el-text-color-secondary, #909399);
  --tvp-math-error: var(--el-color-danger, #f56c6c);
  --tvp-math-border: var(--el-border-color, #dcdfe6);
  --tvp-math-subtle: var(--el-fill-color-light, #f5f7fa);
  --tvp-math-primary: var(--el-color-primary, #409eff);
  --tvp-math-primary-soft: var(--el-color-primary-light-5, #a0cfff);
}
